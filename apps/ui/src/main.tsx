 ...
 * F22 替换 /docs · /process(-files) · /commits · /skills · /settings 五条占位为 Fe-Config 真实页面。
 */
...
const defaultRoutes: RouteSpec[] = [
  ...
  { path: "/docs", nav: "docs", title: "文档 & ROI", element: <DocsAndROIPage /> },
  { path: "/process-files", nav: "process", title: "过程文件", element: <ProcessFilesPage /> },
  { path: "/process", nav: "process", title: "过程文件", element: <ProcessFilesPage /> },
  { path: "/commits", nav: "commits", title: "提交历史", element: <CommitHistoryPage /> },
  { path: "/skills", nav: "skills", title: "提示词 & 技能", element: <PromptsAndSkillsPage /> },
  { path: "/settings", nav: "settings", title: "设置", element: <SystemSettingsPage /> },
];
